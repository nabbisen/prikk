...
acceptance remains required. Design review is active against the accepted committed corrective baseline;
release 0.18.0 does not need to be activated or published first.

...
| DC-64 | [Baseline Reconstruction Cost on the Commit Path](./proposed/DC-64-BASELINE-RECONSTRUCTION-COST.md) | Product **M1** — carries NFR-PERF-01 from DC-56. **Owner-authorized 2026-07-31**, **unblocked** — DC-58 and DC-61 are both complete; needs design review |

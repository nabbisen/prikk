...
| DC-65 | [Text-Edit Baseline Content Availability](./accepted/DC-65-TEXT-EDIT-BASELINE-CONTENT.md) | Product **M1**, **severe correctness defect** — editing one text file in two separate sealed commits fails. Long-standing; reproduced by the architect on `6064da6`. **Accepted 2026-07-31, top of the development lane** ahead of all performance work. Blocks on establishing whether a node's `blob_id` is meant to name a stored object at all — authoring and replay currently disagree |

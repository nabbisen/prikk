...
| 121 | [The CLI's boundary contract](./proposed/121-cli-boundary-contract.md) | Unscheduled. External audit 2026-08-31. EPIPE panic (reproduced), exit-code contract, per-command help, arg-parser hygiene, four undocumented flags. **Owner ruling still open: the exit-code contract's shape** |

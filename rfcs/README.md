...
| DC-65 | [Text-Edit Baseline Content Availability](./proposed/DC-65-TEXT-EDIT-BASELINE-CONTENT.md) | Product **M1**, **severe correctness defect** — editing one text file in two separate sealed commits fails. Long-standing; reproduced by the architect on `6064da6`. **Recommended top of the development lane**, ahead of all performance work; awaits owner acceptance |

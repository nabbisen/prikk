...
| DC-56 | [Commit Scan and Memory Compliance](./accepted/DC-56-COMMIT-FULL-TREE-SCAN-COMPLIANCE.md) | Closes **missed product M1** gate NFR-PERF-01 plus an untracked commit-memory defect. Accepted 2026-07-30; owner ruled the requirement bounds steady-state cost, so a changed-path index is permitted with a cache-validity spec and divergence detection required. Its DC-62 precondition is satisfied — criterion 5 compares against that harness's "Above floor" column |

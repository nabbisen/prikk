...
| 16 | **DC-76** — filesystem durability contract | **ACCEPTED 2026-08-08**, 0.20.0 item 1. Enabling work for the owner's cross-platform mutation goal. 93 `target_os = "linux"` gates today; this states the contract and builds a conformance suite without adding a platform | nothing — **§4 answered before design** | `handoffs/DC-76-filesystem-durability-contract/implementation-handoff-v1.md` |

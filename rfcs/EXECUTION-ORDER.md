...
| 18 | **DC-78** — history exchange | **PROPOSED 2026-08-09.** Status-claim criterion 1, the only one with no increment behind it. Design work, not implementation; may run alongside macOS mutation and **precedes Windows mutation** by owner ruling | owner acceptance | not yet written |

...
| 14 | **DC-74** — merge execution | **PROPOSED 2026-08-04**, roadmap item B. Largest increment on the roadmap. §3 answered the owner's patch-theory question from the operation grammar and **withdrew the RFC's own Route B**: synthesis would re-author others' work. Merge must adopt patches verbatim. Block parentage is now a separable bookkeeping question | owner acceptance | not yet written |

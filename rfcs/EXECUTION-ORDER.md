...
| 21 | **DC-81** — macOS mutation | **ACCEPTED 2026-08-09**, 0.20.0 item 2. The increment the owner's cross-platform priority points at. **First prerequisite is not durability: APFS is case-insensitive by default, which meets NFR-SEC-03 head-on.** Neither developer nor architect can verify locally — a macOS mutation CI job must exist and be green before any gate is relaxed | DC-76 (complete) | `handoffs/DC-81-macos-mutation/implementation-handoff-v1.md` |

...
| 8 | **DC-67** — ordinary-use conformance suite | **PROPOSED 2026-08-02.** The axis DC-41 does not cover: sequences of ordinary operations at N >= 3, each ending in a delete-and-rebuild content assertion. Everything it needs already exists | owner acceptance | not yet written |

...
| 14 | **DC-74** — merge execution | **PROPOSED 2026-08-04**, roadmap item B. Largest increment on the roadmap. **Blocking owner fork**: two-parent blocks (a program) versus single-parent merge patches (one increment) | owner acceptance **and** the Route A/B ruling | not yet written |

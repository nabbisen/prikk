...
| 20 | **DC-83** — test temp-dir uniqueness | **ACCEPTED 2026-08-09, ahead of DC-80.** `format_transition.rs`'s nanos-only temp root collides under parallel test execution; confirmed nondeterministic on `main`. `prikk-store`'s `unique_temp_dir` already has the correct pattern | nothing | `handoffs/DC-83-test-temp-dir-uniqueness/implementation-handoff-v1.md` |

...
| 5 | **DC-65** — text-edit baseline content | **ACCEPTED 2026-07-31, top of the lane.** Editing one text file in two separate sealed commits fails; reproduced by the architect on `6064da6`. Blocks on four questions before a fix is designed | none — **cleared to start** | `handoffs/DC-65-text-edit-baseline-content/implementation-handoff-v1.md` |

...
| 12 | **DC-72** — path-safety conformance (NFR-SEC-03) | **Accepted 2026-08-04.** A stated security guarantee the project does not meet. Blocking prerequisite: which of NFR-SEC-03's five clauses are actually met, per surface | none — **cleared to start** | `handoffs/DC-72-path-safety-conformance/implementation-handoff-v1.md` |
| 13 | **DC-73** — node-model operation apply | **Accepted 2026-08-04**, roadmap item A. First capability increment after the corrective program. Blocking prerequisite: two in-tree sources disagree about whether `ReplaceBinary` materializes — settle by execution | none — **cleared to start** | `handoffs/DC-73-node-model-apply/implementation-handoff-v1.md` |

...
| 10 | **DC-70** — prebuilt binary distribution | **Accepted 2026-08-03.** Removes the Rust-toolchain prerequisite; unlocks `cargo binstall`. Blocking: release evidence models one archive, not N — a schema question before a workflow question | none — **cleared to start** | `handoffs/DC-70-prebuilt-binary-distribution/implementation-handoff-v1.md` |

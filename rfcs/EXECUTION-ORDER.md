...
| 6 | **DC-66** — multi-commit queuing | **Accepted 2026-08-02.** Unblocks DC-57; makes NFR-PERF-02/03 meetable. **Scope warning:** block format and `seal` already support N, so the cap is three guards — the increment is **crash recovery, `verify`, and ordering** | none — **cleared to start** | `handoffs/DC-66-multi-commit-queuing/implementation-handoff-v1.md` |

...
| 11 | **DC-71** — non-Linux build conformance | **Accepted 2026-08-04**, with the owner ruling that **portable read-only is a requirement**. `prikk-store` does not compile off Linux; the absent non-Linux CI build is why it drifted silently | none — **cleared to start** | `handoffs/DC-71-non-linux-build-conformance/implementation-handoff-v1.md` |

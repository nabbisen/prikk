...
| 15 | **DC-75** — merge block lineage / structural merge record | **PROPOSED 2026-08-08.** Discharges DC-74's release condition. Sequencing ruled 2026-08-08: **not a prerequisite for DC-74** — the developer sized it and the architect's "confined to derived-state machinery" estimate was wrong; the gate is `block_state.rs:13-26` rejecting `BlockKind::Merge` outright | owner acceptance | not yet written |

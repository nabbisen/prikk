...
| 12 | **DC-72** — path-safety conformance (NFR-SEC-03) | **PROPOSED 2026-08-04.** A stated security guarantee the project does not meet, unowned since 2026-07-30. Blocking prerequisite: which of NFR-SEC-03's five clauses are actually met, per surface | owner acceptance | not yet written |

...
| 9 | **DC-69** — lifecycle-state retention | **PROPOSED 2026-08-03.** Design increment: does a prikk repository forget anything, ever? Blocking prerequisite is whether `seen_ids` is load-bearing or belt-and-braces against degraded entropy | owner acceptance | not yet written |

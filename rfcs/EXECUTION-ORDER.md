...
| 13 | **DC-73** — node-model operation apply | **PROPOSED 2026-08-04**, roadmap item A. The first increment in this program that adds capability rather than correcting a defect. Blocking prerequisite: two in-tree sources disagree about whether `ReplaceBinary` materializes — settle by execution | owner acceptance | not yet written |

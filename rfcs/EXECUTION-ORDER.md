...
| 11 | **DC-71** — non-Linux build conformance | **PROPOSED 2026-08-04.** `prikk-store` does not compile off Linux, contradicting DC-37's stated design. The absent non-Linux CI build is why it drifted silently | owner acceptance, and one owner ruling inside it | not yet written |

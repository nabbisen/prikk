...
| 10 | **DC-70** — prebuilt binary distribution | **PROPOSED 2026-08-03.** Removes the Rust-toolchain prerequisite from installation; unlocks `cargo binstall`. Blocking: release evidence models one archive, not N | owner acceptance | not yet written |

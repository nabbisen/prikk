...
- [`141-publication-through-ci.md`](rfcs/proposed/141-publication-through-ci.md) — RFC 141, Publishing through CI, and the evidence nobody has ever produced (opened 2026-09-06 on the owner's proposal to integrate publication with CI via crates.io Trusted Publishing. **Recommends adopting it, on a security argument: a stored registry token is a standing credential; Trusted Publishing has nothing durable to steal.** The stronger case is §3's finding — **DC-35 specifies a release-evidence regime, `release-evidence-v1.schema.json` exists, the oracle carries 73 cases for it, and no release has ever emitted one.** §4 settles a question the architect raised first: `release-signers.toml` gates the **tag** leg of DC-35's authority composition, not registry publication, so no past release was out of compliance. **§5.1 is a hard requirement** — publication must not become automatic on tag; the publish job runs behind a required-reviewer environment, because a burned version number is irreversible. **Needs owner acceptance**)
...
measurement corpus, owner-accepted 2026-09-06 the day it was opened, unimplemented), and **140**
(queued-patch enumeration, owner-accepted 2026-09-06 the day it was opened, handed off). **130 and 138

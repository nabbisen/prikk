...
//!
//! PR-005 exposes minimal repository layout commands and active WAL status. WAL support is
//! present in the storage crate but not yet exposed as an end-user commit workflow.
...
fn run() -> std::result::Result<(), String> {
    ...
    match args.next().as_deref() {
        ...
        Some("status") => {
            ...
            println!("status: refs, patch algebra, plugins, and sync not implemented in PR-005");
            Ok(())
        }

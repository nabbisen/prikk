...
pub(crate) const COMMANDS: &[Command] = &[
    ...
    Command {
        ...
        help_lines: &[
            ...
            "  prikk sync build <ref> --have <file> --output <file>  Build a PEXCH002 artifact closing the gap",
            ...
            "  prikk sync accept <file> [--claims-out <file>]  Accept a PEXCH002 artifact (prints claim ids; optionally writes them)",

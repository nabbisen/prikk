...
pub use patch::{
    ...
    OperationKind, PATCH_PARENT_IDS_RETIRED_SCHEMA, PATCH_TEXT_SPAN_V2_SCHEMA, PatchPayload,
    PatchPurpose, RenamePath, ReplaceBinary, TEXT_SPAN_ANCHOR_MIN_LEN, TEXT_SPAN_HASH_BYTES,
    is_canonical_file_mode, text_span_hash, validate_text_anchor_id,
};

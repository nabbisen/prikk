...
fn loads_frozen_repository_oracle() {
    ...
    // RFC 119 track B: 111 -> 57 (23 release-state + 15 json-parser/schema-evaluator removed
    // outright; 16 release-evidence signer-governance cases parked in the same file).
    assert_eq!(oracle.manifest.cases.len(), 57);
}
